...
(function($) {
  ...
  $(window).on('load', function() {
    ...
    $.get('https://cors-anywhere.herokuapp.com/https://medium.com/@akulavarunkumar/achieving-artificial-general-intelligence-agi-using-meta-learning-learning-to-learn-51fcaa1f46de', 
function(data) {
...
$.get('https://cors-anywhere.herokuapp.com/https://medium.com/@akulavarunkumar/hello-world-of-tensorflow-js-25650cc12f0e', 
function(data) {
  var im = $(data).filter('meta[name="twitter:image:src"]').attr("content");
